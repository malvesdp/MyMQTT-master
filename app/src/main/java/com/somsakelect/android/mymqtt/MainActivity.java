...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Subscribe
        findViewById(R.id.sub_btn).setOnClickListener(v -> subscribe(getEnter(eSubTp)));

        //Publish
        findViewById(R.id.pub_btn).setOnClickListener(v -> publish(getEnter(ePubTp), getEnter(ePubMsg)));
